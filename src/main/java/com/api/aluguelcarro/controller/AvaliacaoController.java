...
import com.api.aluguelcarro.model.AvaliacaoDTO;
...
public class AvaliacaoController {
	...
	public List<AvaliacaoDTO> searchEvaluationsByVehicle(@PathVariable("idVeiculo") Integer idVeiculo){
		AvaliacaoDTO evaluation = new AvaliacaoDTO();
		...
		evaluation.setIdVeiculo(12l);
		List<AvaliacaoDTO> evaluations = new ArrayList<>();
	...
	public AvaliacaoDTO saveEvaluation(@RequestBody AvaliacaoDTO avaliacao) {
		return avaliacao;
	}
}
