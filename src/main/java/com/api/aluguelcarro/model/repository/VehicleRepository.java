...
import com.api.aluguelcarro.model.EstatisticaVeiculoDTO;
...
public interface VehicleRepository extends CrudRepository<Vehicle, Integer> {
    ...
    List<Vehicle> getVehiclesByFilter(@Param("nome") String nome, @Param("cidade") String cidade, @Param("fabricante") String fabricante);
